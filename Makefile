...
shvs:
	env GOOS=linux GOSUMDB=off GOPROXY=direct go build -ldflags "-X github.com/intel-secl/sgx-hvs/v3/version.BuildDate=$(BUILDDATE) -X github.com/intel-secl/sgx-hvs/v3/version.Version=$(VERSION) -X github.com/intel-secl/sgx-hvs/v3/version.GitHash=$(GITCOMMIT)" -o out/shvs
