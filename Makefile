...
shvs:
	env GOOS=linux GOSUMDB=off GOPROXY=direct go build -ldflags "-X github.com/intel-secl/intel-secl/v3/pkg/cms/version.BuildDate=$(BUILDDATE) -X github.com/intel-secl/intel-secl/v3/pkg/cms/version.Version=$(VERSION) -X github.com/intel-secl/intel-secl/v3/pkg/cms/version.GitHash=$(GITCOMMIT)" -o out/shvs
